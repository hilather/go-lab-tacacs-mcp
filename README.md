...
<p align="center">
  ...
  <img alt="Go 1.26.8" src="https://img.shields.io/badge/Go-1.26.8-00ADD8?labelColor=1a1f24" />
...
| License | Apache-2.0 |
| Toolchain | Go **1.26.8** (module `go 1.26.0`) · Node.js **22.14.0** |
...
| RadSec | Optional RADIUS/TLS 1.3 stream on TCP 2083, default off. Not “UDP plus TLS.” PAP/CHAP only until EAP/MS-CHAP land. |
| Deferred | EAP termination, CoA/Disconnect, DTLS/RADIUS/1.1, RADIUS MS-CHAP, custom dictionaries, persistent accounting. |
...
git clone https://github.com/hilather/go-lab-tacacs-mcp.git
cd go-lab-tacacs-mcp
# Go 1.26.8 and Node 22.14.0 — see go.mod toolchain and .nvmrc
make test
...
- Go **1.26.8** (`go.mod` `toolchain go1.26.8`)
