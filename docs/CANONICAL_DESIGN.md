...
| Access-Challenge | `R65-ACCESS-004` is `DEFERRED_MAY`. In-memory State store exists; **no Access-Challenge on the live listener** until EAP lands. Program ADR [0021](https://github.com/hilather/go-lab-tacacs-mcp/blob/main/docs/decisions/0021-radius-access-challenge-state-gate.md). |
