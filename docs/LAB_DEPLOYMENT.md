...
The MCP endpoint must be reachable through the same HTTP server and authorization middleware as REST. The reference URI and transport behavior must be documented in the deployment README and integration tests.
