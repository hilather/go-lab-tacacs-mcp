...
| PEAP Start (outer type 25 + TLS-in-EAP) | `RAD-PEAP-001` | Start increment only — not complete PEAP | [0030](https://github.com/hilather/go-lab-tacacs-mcp/blob/main/docs/decisions/0030-radius-peap-tls-in-eap-start.md) | Identity→PEAP Start when `peap` opted in; handshake/inner EAP is `RAD-PEAP-002` |
