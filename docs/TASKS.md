...
- [x] `RAD-EXT-005` RadSec first slice: RADIUS/TLS 1.3 on TCP 2083. [ADR 0025](https://github.com/hilather/go-lab-tacacs-mcp/blob/main/docs/decisions/0025-radius-radsec-tls13-first-slice.md). Not a thin TLS wrap of UDP. DTLS and RADIUS/1.1 are deferred (Revisit). DAC CoA stays UDP.
