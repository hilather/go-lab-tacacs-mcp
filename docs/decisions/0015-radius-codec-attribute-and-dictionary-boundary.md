...
Rejected. User decision 2026-08-14: wait for independent IOL vectors.
...
- Named vendor dictionaries wait on interop evidence.
...
- Interop requires a reviewed custom-dictionary ADR.
