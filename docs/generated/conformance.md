...
| Gate | Result |
|---|---|
| RADIUS / project MVP rows | **PASS** (43/43 mandatory rows `PASS` or deferred with ADR evidence) |
...
RADIUS MVP MUST rows are evidenced or deferred with an ADR. Tunneled EAP stays `DEFERRED_MAY`. External radclient/device interop is not claimed. Do **not** advertise complete RADIUS. TACACS 1.0 `-release` still gates only RFC 8907/9887.
...
| R65-VSA-001 | MUST | PASS | Parse/encode VSA framing and preserve unknown vendor data safely | unit:internal/radius/attribute.TestParseVSARoundTrip; unit:internal/radius/attribute.TestParseVSAUnknownVendorPreserved; unit:internal/radius/attribute.TestPacketKeepsMalformedVSARaw; unit:internal/radius/attribute.TestParseVendorTLVsMultipleAndUnknown; unit:internal/radius/codec.TestVSAGoldenFraming; unit:internal/radius/testclient/codec.TestIndependentVSAFraming; fuzz:internal/radius/attribute.FuzzRadiusVSA; fuzz:internal/radius/attribute.FuzzRadiusVendorTLVs; golden:testdata/protocol/radius/packets/access-request-vsa.bin |
...
| R65-ACCESS-004 | MUST | PASS | Access-Challenge only under complete state/security gate | adr:docs/decisions/0021-radius-access-challenge-state-gate.md; unit:internal/radius/udp.TestIndependentTestclientEAPIdentityMD5Wire; unit:internal/radius/server.TestEAPIdentityIssuesMD5Challenge; unit:internal/radius/runtime.TestChallengeIssueConsumeUDPAndTLS; fuzz:internal/radius/codec.FuzzRadiusPacketDecode |
...
| PRJ-COA-001 | PROJECT MUST | PASS | DAC originate CoA/Disconnect uses the client UDP RADIUS secret; handle needs Accounting-Start; explicit dest for access-only labs; MA required | unit:internal/radius/runtime.TestSessionIndexStartInterimStop; unit:internal/radius/runtime.TestSessionIndexOnOffFlushByPeerOrNAS; unit:internal/radius/server.TestOriginateCoAACKIndependentTestclient; unit:internal/api/operations.TestRadiusDynAuthRequiresScope; unit:internal/api/operations.TestRadiusDynAuthRejectsExpectedRevision; unit:internal/api/operations.TestRadiusSessionsListRedactsAcctSessionID; adr:docs/decisions/0024-radius-coa-disconnect.md |
| PRJ-UL-001 | PROJECT MUST | PASS | Access-Reject reject_password_change_required after good PAP/CHAP + must_change_login; no extra attributes; no Access-Challenge | unit:internal/aaa.TestAuthenticateAccessMustChangeRejectsWithoutPolicy; unit:internal/radius/server.TestReasonTableStable; unit:internal/radius/server.TestEAPMustChangeIndistinguishableFromBadPassword; docs:docs/designs/radius-authentication.md |
...
| PRJ-DICT-001 | PROJECT MUST | PASS | Operator dictionaries are TacLab YAML, local, size-capped, and fail-closed; reserved vendors 0/9/311 and Cisco-AVPair / MS-CHAP-* collide as compile errors; DictionaryVersion stays builtin-mvp-1 when no operator file compiled | unit:internal/radius/attribute.TestMergeOperatorEmptyKeepsBuiltinVersion; unit:internal/radius/attribute.TestMergeOperatorRejectsReservedVendors; unit:internal/radius/attribute.TestMergeOperatorRejectsReservedNames; unit:internal/radius/attribute.TestMergeOperatorRejectsSecretSensitivityDowngrade; unit:internal/config.TestCompileRADIUSDictionaryEmptyStaysBuiltin; unit:internal/config.TestCompileRADIUSDictionaryRejectsReservedVendorFile; unit:internal/state.TestReloadInvalidOperatorDictionaryKeepsSnapshot; unit:internal/api/operations.TestRadiusAttributesListOperatorSource; adr:docs/decisions/0026-radius-operator-dictionaries.md |
| PRJ-CISCO-001 | PROJECT MUST | PASS | Named Cisco-AVPair (vendor 9, vendor-type 1) decode/encode with independent fixtures | unit:internal/radius/attribute.TestNamedCiscoAVPair; unit:internal/radius/attribute.TestNamedAndRawCiscoAVPairSameWire; unit:internal/radius/attribute.TestParseVendorTLVsCiscoAVPairGolden; unit:internal/radius/attribute.TestParseVendorTLVsEdges; unit:internal/radius/testclient/codec.TestIndependentCiscoAVPairGolden; unit:internal/radius/testclient/codec.TestIndependentCiscoAVPairEdges; unit:internal/policy/radius.TestCompileNamedAndRawCiscoAVPairSameKey; unit:internal/aaa.TestEncodePolicyReplyNamedAndRawCiscoAVPairSameWire; unit:tools/ciscolab.TestRADIUSCiscoAVPairScenarioSkipIsNotPass; golden:testdata/protocol/radius/cisco/avpair-priv-lvl.bin; golden:testdata/protocol/radius/cisco/avpair-priv-lvl.json; fuzz:internal/radius/attribute.FuzzRadiusVendorTLVs; bench:internal/radius/attribute.BenchmarkParseVendorTLVs_CiscoAVPair; adr:docs/decisions/0027-named-cisco-avpair-independent-fixtures.md; docs:docs/INTEROP.md; interop:make cisco-lab RADIUS scenario SKIP without TACLAB_IOL_IMAGE; skip is not PASS |
| PRJ-RADSEC-001 | PROJECT MUST | PASS | RADIUS/TLS 1.3 (RadSec) is a length-prefixed TCP stream on 2083 with mTLS; shared secret still required; PAP/CHAP on the stream | unit:internal/radius/tls.TestIndependentTestclientPAPOnRadSec; unit:internal/radius/tls.TestReadPacketDoesNotStitch; unit:internal/radius/tls.TestNoForbiddenImports; unit:internal/config.TestRADIUSTransportTLSAndUDPPerCarrier; unit:internal/config.TestCertificateOnlyLegalWithRADIUSTLS; unit:internal/radius/server.TestAccessUsesRequestCarrier; adr:docs/decisions/0025-radius-radsec-tls13-first-slice.md |
| PRJ-RADSEC-002 | PROJECT MUST | DEFERRED_MAY | RADIUS/DTLS and RADIUS/1.1 are not implemented | adr:docs/decisions/0025-radius-radsec-tls13-first-slice.md; docs:docs/RADIUS_CONFORMANCE.md |
