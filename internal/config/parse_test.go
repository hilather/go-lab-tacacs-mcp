...
func TestRejectFixtures(t *testing.T) {
	...
	cases := []struct {
		...
		{"testdata/reject/v1_radius_policies.yaml", domain.CodeConfigUnknownField, "radius_policies", ""},
		{"testdata/reject/v1_radius_dictionaries.yaml", domain.CodeConfigUnknownField, "radius_dictionaries", ""},
		{"testdata/reject/v2_radius_dictionaries_remote.yaml", domain.CodeConfigYAMLInvalid, "radius_dictionaries", "local"},
		{"testdata/reject/v2_radius_dictionaries_s3.yaml", domain.CodeConfigYAMLInvalid, "radius_dictionaries", "local"},
		{"testdata/reject/v2_radius_dictionaries_include.yaml", domain.CodeConfigYAMLInvalid, "radius_dictionaries", "$include"},
		{"testdata/reject/v2_radius_dictionaries_relative.yaml", domain.CodeConfigYAMLInvalid, "radius_dictionaries", "absolute"},
		{"testdata/reject/v2_radius_dictionaries_unknown_field.yaml", domain.CodeConfigUnknownField, "include", ""},
		{"testdata/reject/v2_radius_policy_unknown_field.yaml", domain.CodeConfigUnknownField, "regex", ""},
		{"testdata/reject/v1_user_radius_policy.yaml", domain.CodeConfigUnknownField, "radius_policy_id", ""},
		{"testdata/reject/v1_group_radius_policy.yaml", domain.CodeConfigUnknownField, "radius_policy_id", ""},
		{"testdata/reject/v2_radius_policies.yaml", domain.CodeConfigUnknownField, "radius_rules", ""},
