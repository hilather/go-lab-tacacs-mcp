...
func mvpDefinitions() []Definition {
	return []Definition{
		define("User-Name", TypeUserName, KindText, CardinalitySingle, SensitivityRestricted,
			maskOf(PacketAccessRequest, PacketAccessAccept, PacketAccessChallenge, PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		...
		define("NAS-IP-Address", TypeNASIPAddress, KindIPv4, CardinalitySingle, SensitivityRestricted,
			maskOf(PacketAccessRequest, PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		...
		define("Reply-Message", TypeReplyMessage, KindText, CardinalityMulti, SensitivityPublic,
			maskOf(PacketAccessAccept, PacketAccessReject, PacketAccessChallenge, PacketCoARequest, PacketCoAACK, PacketDisconnectACK, PacketCoANAK, PacketDisconnectNAK)),
		...
		define("Class", TypeClass, KindString, CardinalityMulti, SensitivityRestricted,
			maskOf(PacketAccessAccept, PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		...
		define("Session-Timeout", TypeSessionTimeout, KindInteger, CardinalitySingle, SensitivityPublic,
			maskOf(PacketAccessAccept, PacketAccessChallenge, PacketCoARequest)),
		...
		define("Proxy-State", TypeProxyState, KindString, CardinalityMulti, SensitivityPublic,
			maskOf(PacketAccessRequest, PacketAccessAccept, PacketAccessReject, PacketAccessChallenge, PacketAccountingRequest, PacketAccountingResponse,
				PacketDisconnectRequest, PacketDisconnectACK, PacketDisconnectNAK, PacketCoARequest, PacketCoAACK, PacketCoANAK)),
		...
		define("Acct-Session-Id", TypeAcctSessionID, KindText, CardinalitySingle, SensitivityRestricted,
			maskOf(PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		...
		define("Event-Timestamp", TypeEventTimestamp, KindTime, CardinalitySingle, SensitivityPublic,
			maskOf(PacketAccessRequest, PacketAccessAccept, PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		...
		define("NAS-IPv6-Address", TypeNASIPv6Address, KindIPv6, CardinalitySingle, SensitivityRestricted,
			maskOf(PacketAccessRequest, PacketAccountingRequest, PacketDisconnectRequest, PacketCoARequest)),
		define("Error-Cause", TypeErrorCause, KindInteger, CardinalitySingle, SensitivityPublic,
			maskOf(PacketDisconnectNAK, PacketCoANAK)),
