...
//
// The key must be the legacy TACACS+ shared secret. This helper does not
// accept credential or TLS PSK types; adapters must not pass those values.
// Whether to apply the pad (legacy transport, UNENCRYPTED_FLAG clear) is
