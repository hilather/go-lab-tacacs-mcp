...
// ID is the configuration key for the legacy TACACS socket.
func (l *Listener) ID() string { return runtime.IDLegacyTACACS }

// Protocol is always TACACS.
func (l *Listener) Protocol() domain.Protocol { return domain.ProtocolTACACS }

// Carrier is the legacy TCP binding. This is not a domain.Transport value.
func (l *Listener) Carrier() domain.Carrier { return domain.CarrierTACACSLegacyTCP }
